...
auto getFromIdx = [](ROOT::VecOps::RVec<float> v, ROOT::VecOps::RVec<int> idx){ return Take(v,idx);};
...
.Define("jetPtCut","25")
.Define("Jet_muonIso", getFromIdx, {"Muon_iso", "Jet_muonIdx1"})
...
;
auto h=toplevel.Histo1D("Higgs_pt");
auto h1=toplevel.Filter("twoJets").Histo1D("Mqq");
